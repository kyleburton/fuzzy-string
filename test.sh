...
bin/fuzzy.rb -f data/lnames.txt find soundex burton
bin/fuzzy.rb -f data/lnames.txt find nysiis burton
bin/fuzzy.rb -f data/lnames.txt find meta burton
bin/fuzzy.rb -f data/lnames.txt find edist burton
bin/fuzzy.rb -f data/lnames.txt find -t 0.70 edist burton
bin/fuzzy.rb -f data/lnames.txt -t 0.70 find edist burton
bin/fuzzy.rb -f data/lnames.txt -t 0.65 find edist burton
bin/fuzzy.rb -f data/lnames.txt -h -t 0.65 find edist burton
...
bin/fuzzy.rb -s typo brew foo fah
bin/fuzzy.rb brew foo fah
bin/fuzzy.rb -f data/lnames.txt find brew burton
bin/fuzzy.rb --help
